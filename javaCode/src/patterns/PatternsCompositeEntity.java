...
//Паттерн Композит Энтити, есть взаимосвязь между сервисами, паттерн объединяет их всех в один объект
// и клиент дергает одну сущность и берет то, что ему от всех нужно
